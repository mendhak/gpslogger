...
public class GpsSettingsActivity extends PreferenceActivity
{
    ...
    /**
     * Converts metric values to imperial and vice versa, within preferences
     */
    private class ImperialPreferenceChangeListener implements OnPreferenceChangeListener
    {
