...
public class CustomUrlLoggerTest {
    ...
    public void getFormattedUrl_WhenPlaceholders_ValuesSubstituted() throws Exception {
        ...
        CustomUrlLogger logger = new CustomUrlLogger("",0,"", false);
        ...
        assertThat("Placeholders are substituted", logger.getFormattedUrl(urlTemplate,loc, "blah", "22", 91, "SRS11", 0,""), is(expected));
    }
    ...
    public void getFormattedUrl_WhenValuesMissing_UrlReturnsWhatsAvailable() throws Exception {
        ...
        String urlTemplate = "http://192.168.1.65:8000/test?lat=%LAT&lon=%LON&sat=%SAT&desc=%DESC&alt=%ALT&acc=%ACC&dir=%DIR&prov=%PROV&spd=%SPD&time=%TIME&battery=%BATT&androidId=%AID&serial=%SER&activity=%ACT";
        assertThat("Placeholders are substituted", logger.getFormattedUrl(urlTemplate,loc, "", "", 0, "", 0,""), is(expected));
    }
    ...
    public void getFormattedUrl_WhenTimeStamp_UseUnixEpoch() throws Exception {
        ...
        assertThat("Unix timestamp is in seconds", logger.getFormattedUrl(urlTemplate, loc, "", "", 0, "", 0,""), is(expected));
        ...
        assertThat("Unix timestamp with 000 to fake milliseconds", logger.getFormattedUrl(urlTemplate, loc, "", "", 0, "", 0,""), is(expected));
    ...
    public void getFormattedUrl_WhenStartTime_AddSessionStartTime() throws Exception {
        ...
        assertThat("Start timestamp is in seconds", logger.getFormattedUrl(urlTemplate, loc, "", "", 0, "", 1495884681283l,""), is(expected));
        ...
        assertThat("Absence of start timestamp recorded as 0", logger.getFormattedUrl(urlTemplate, loc, "", "", 0, "", 0l,""), is(expected));
    }
    ...
    public void getFormattedUrl_WhenFilename_AddFilename() throws Exception {
        ...
        assertThat("Start timestamp is in seconds", logger.getFormattedUrl(urlTemplate, loc, "", "", 0, "", 1495884681283l, "20170527abc"), is(expected));
