...
public class StringsTest {
    ...
    public void getHexColorCodeFromInt_whenGreen_returnGreen(){
        ...
        assertThat("0xff00ff00 or -16711936 matches green", actual, is(expected));
    }

    @Test
    public void getHexColorCodeFromInt_whenEmpty_returnBlack(){
        String expected = "#000000";
        String actual = Strings.getHexColorCodeFromInt(0); //0xff00ff00 or -16711936
        assertThat("0 matches black", actual, is(expected));
    }
