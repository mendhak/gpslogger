...
> Automatically *upload or email* the file at set intervals to destinations such as *Email, FTP, SFTP, Dropbox, Google Drive, Custom URL, OpenStreetMap, ownCloud, OpenGTS, or Dawarich*.  
